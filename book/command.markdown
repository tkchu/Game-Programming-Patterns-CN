...
让我扩展一下。“具现化”，如果你没有听说过的话，它的意思是“实例化，对象化”。
另外一种具现化的解释方式是将某事物作为“第一公民”对待。
...
这展现了命令模式应用时的一种情形。
在某些情形中，就像之前例子，指令是可重用的对象，代表了*可执行的事件*。
...
class="gof-pattern">备忘录</a>模式使用的地方，它从来没有有效的工作过。
